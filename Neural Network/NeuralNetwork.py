...
class NeuralNetwork:
    ...
    def backprop(self, a3, a2, a1, groundtruth, theta1, theta2, z2):
        ...
        Theta2Grad=(1./self.m)*delta2
        Theta1Grad=(1./self.m)*delta1
        
        reg1=self.C1*(1./self.m)*theta1[:,1:]
        reg2=self.C1*(1./self.m)*theta2[:,1:]
...
def runNN():
    ...
    gd=NN.groundtruth(y) # ground_truth
    ...
    for i in range(0, Maxiter):
        ...
        J = NN.cost(y, hy, theta1, theta2, gd)   
